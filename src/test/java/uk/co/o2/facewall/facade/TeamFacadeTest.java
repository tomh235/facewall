...
public class TeamFacadeTest {
    ...
    public void map_teams_to_teamlist_test() {
        ...
        Team team1 = new StubbedTeam("team1", "blue", new ArrayList<>(Arrays.asList(person1)));
        Team team2 = new StubbedTeam("team2", "red", new ArrayList<>(Arrays.asList(person2,person3)));
        Team team3 = new StubbedTeam("team3", "green", new ArrayList<>(Arrays.asList(person4,person5,person6)));
